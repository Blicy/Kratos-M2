...
function optionsframework_options(){
    ...
    $options[] = array(
        'name'=>'QQ群二维码',
        'desc'=>'上传你的QQ群二维码图片，尺寸要大于等于150px',
        'id'=>'qqgroup_image',
        'std'=>get_template_directory_uri().'/images/qqg.jpg',
        'type'=>'upload');
    $options[] = array(
        'name'=>'建站时间',
    ...
    $options[] = array(
        ...
        'id'=>'wechatpayqr_url',
        'std'=>get_template_directory_uri().'/images/wechatpayqr.jpg',
        'type'=>'upload');
    $options[] = array(
        'name'=>'支付婊收款码',
        'desc'=>'上传你的支付婊收款二维码图片，图片尺寸要大于200px',
        'id'=>'alipayqr_url',
        'std'=>get_template_directory_uri().'/images/alipayqr.jpg',
        'type'=>'upload');
    $options[] = array(
        'name'=>'SEO配置',
        'type'=>'heading');
