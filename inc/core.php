...
function kratos_theme_scripts(){  
    ...
    if(!is_admin()){
        wp_enqueue_style('fontawe',$fadir,array(),'4.X');
        wp_enqueue_style('NProgress',$dir.'/css/nprogress.css',array(),'0.2.0');
        ...
        wp_enqueue_script('bootstrap',$bsdir,array(),'3.3.X');
        wp_enqueue_script('NProgress',$dir.'/js/nprogress.js',array(),'0.2.0');
        wp_enqueue_script('kratos',$dir.'/js/kratos.js',array(),KRATOS_VERSION);
        wp_enqueue_script('PJAX',$dir.'/js/pjax.js',array(),'0.0.7');
    }
