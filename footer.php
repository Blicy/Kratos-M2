                <footer>
                    <div id="footer">
                        <div class="cd-tool text-center">
                            <?php if(current_user_can('manage_options')&&is_single()||is_page()){ ?><div class="<?php if(kratos_option('cd_qqg')) echo 'edit-box2 '; ?>edit-box"><?php echo edit_post_link('<span class="fa fa-pencil"></span>'); ?></div><?php } ?>
                            <div class="<?php if(kratos_option('cd_qqg')) echo 'gotop-box2 '; ?>gotop-box"><div class="gotop-btn"><span class="fa fa-chevron-up"></span></div></div>
                            <?php if(kratos_option('cd_qqg')) echo '<div id="qqg-img" class="qqg-img"><span class="fa fa-qq"></span><div id="qqg-pic"><img src="'.kratos_option('qqgroup_image').'"></div></div>'; ?>
